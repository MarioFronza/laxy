...
fun questionAttemptPersistence(questionAttemptsQueries: QuestionAttemptsQueries) = object : QuestionAttemptPersistence {
    ...
    override suspend fun selectQuestionAttemptsBy(questionId: QuestionId) =
        withSpan("$spanPrefix.selectQuestionAttemptsBy") {
            questionAttemptsQueries.selectQuestionAttemptByQuestionId(questionId) { userSelectedOption, isCorrect ->
                QuestionAttempt(
                    id = questionId,
