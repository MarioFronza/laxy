...
@Serializable
data class UserThemeWrapper<T : Any>(val theme: T)

@Serializable
data class NewUser(val username: String, val email: String, val password: String)

@Serializable
data class NewTheme(val description: String)
...
@Serializable
data class UserTheme(val description: String)
...
data class UsersResource(val parent: RootResource = RootResource) {
    ...
    @Resource("/theme")
    data class Theme(val parent: UsersResource = UsersResource())
}
