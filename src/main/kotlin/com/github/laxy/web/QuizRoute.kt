...
private const val spanPrefix = "route.quiz"
...
fun Route.quizRoutes(
    ...
    authenticate("auth-session") {
        get("/dashboard") {
            withSpan("$spanPrefix.GET /dashboard") { span ->
                val current = call.currentUserOrRedirect() ?: return@withSpan
                either {
                        val quizzes =
        ...
        get("/quizzes") {
            withSpan("$spanPrefix.GET /quizzes") { span ->
                call.currentUserOrRedirect() ?: return@withSpan
                either {
                        val subjects =
        ...
        post("/quizzes") {
            withSpan("$spanPrefix.POST /quizzes") { span ->
                val current = call.currentUserOrRedirect() ?: return@withSpan
        ...
        get("/quizzes/{id}/questions") {
            withSpan("$spanPrefix.GET /quizzes/{id}/questions") { span ->
                call.currentUserOrRedirect() ?: return@withSpan
        ...
        post("/quizzes/{id}/attempt") {
            withSpan("$spanPrefix.POST /quizzes/{id}/attempt") { span ->
                call.currentUserOrRedirect() ?: return@withSpan
        ...
        post("/quizzes/{id}") {
            withSpan("$spanPrefix.POST /quizzes/{id}") {
                call.currentUserOrRedirect() ?: return@withSpan
                val quizId = call.parameters["id"].orEmpty()
