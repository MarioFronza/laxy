...
fun <ID, OD> List<InteractionResult<ID>>.accumulateErrors(value: OD): InteractionResult<OD> {
    val errors =
        this.filterIsInstance<Failure<ApplicationError>>().flatMap { it.applicationError.errors }
